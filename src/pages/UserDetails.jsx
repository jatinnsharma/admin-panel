                      ...
                      <div class="text-gray-700">
                        <div class="grid md:grid-cols-2 text-sm">
                          <div class="grid grid-cols-2">
                            ...
                            <div class="px-4 py-2">{username}</div>
                          </div>
                          <div class="grid grid-cols-2">
                            <div class="px-4 py-2  font-semibold">UserId</div>
                            <div class="px-4 py-2 text-xs">{_id}</div>
                          </div>
                          <div class="grid grid-cols-2">
                          ...
                          <div class="grid grid-cols-2">
                            ...
                            <div class="px-4 py-2">{mobileNumber}</div>
                          </div>
                          <div class="grid grid-cols-2">
                            <div class="px-4 py-2 font-semibold">
                              Current Address
                            ...
                            <div class="px-4 py-2">
                              {currentAddress ? currentAddress : "Not Updated"}
                            </div>
                          </div>
                          <div class="grid grid-cols-2">
                            <div class="px-4 py-2 font-semibold">
                            ...
                            <div class="px-4 py-2">
                              {permanentAddress
                                ...
                                {console.log(hobbies)}
                          <div class="grid grid-cols-2">
                            <div class="px-4 py-2 font-semibold">Hobbies</div>
                            <div class="px-4 py-2">
                              {hobbies.length > 0 ? hobbies : "Not Updated"}
                            </div>
                          </div>
                          ...
                          <div class="grid grid-cols-2">
                            ...
                            <div class="px-4 py-2 text-blue-800">
                              <Link to={aadharCard}>View</Link>
                            </div>
                          </div>
                          <div class="grid grid-cols-2">
                            <div class="px-4 py-2 font-semibold">Joined On</div>
                            <div class="px-4 py-2 ">
